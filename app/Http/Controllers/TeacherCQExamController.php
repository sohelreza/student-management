...
class TeacherCQExamController extends Controller
{
    public function exam_list()
    {
    	$admin=Auth::guard('admin')->user(); 
        $exams=CqExam::where('teacher_id',$admin->id)->get();

        return view('teacher.cqExam.cqExamList',compact('exams'));
    }

     public function add_cq_exam(){

         
        return view('teacher.cqExam.cqExamAdd');
    }
    ...
    public function change_cq_exam_status(Request $request){
     ...
     public function edit_cq_exam($id){
        ...
        $exam=CqExam::find($id);
        return view('teacher.cqExam.cqExamEdit',compact('exam'));
    }
    ...
    public function add_cq_question($id){
        ...
        $exam=CqExam::find($id);
        return view('teacher.cqExam.cqQuestionAdd',compact('exam'));
    }
    ...
    public function upload_cq_image(Request $request) { 
     ...
     public function view_cq_question($id){
        ...
        return view('teacher.cqExam.cqQuestionView',compact('questions','exam'));
    }
    ...
    public function edit_cq_question($id){
        ...
        return view('teacher.cqExam.cqQuestionEdit',compact('question'));
     ...
     public function cq_exam_result()
    {
        ...
        return view('teacher.cqExamResult.cqExamList',compact('exams'));
    }
    ...
    public function cq_exam_result_view($id)
    {
        ...
        return view('teacher.cqExamResult.studentList',compact('students'));
    }
    ...
    public function pdfStudentAnswer($exam_id,$student_id)
    {
        ...
        $pdf = PDF::loadView('teacher.cqExamResult.pdfStudentAnswer', compact('exam_answers') );
    ...
    public function studentMarking($exam_id,$student_id)
    {
        ...
        return view('teacher.cqExamResult.marking',compact('exam_student'));
     ...
     public function studentMarkingUpdate(Request $request)
    {
        ...
        return redirect('teacher/cq_exam_result/');
    ...
    public function add_solve_sheet($id)
    {
        ...
        return view('teacher.cqExamResult.addSolveSheet',compact('cq_exam'));
    }
