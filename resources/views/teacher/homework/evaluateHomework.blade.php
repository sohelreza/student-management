   ...
   <header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Homework Evaluation</span></li>
							</ol>
					    </div>
					</header>
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="{{action('TeacherHomeworkController@evaluateHomeworkScore',$homework->id)}}" method="post">
									@csrf
