   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="{{ action('TeacherZoomClass@add') }}"><i class="fa fa-plus"></i> Add
								</a>
								</div>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												<form action="{{action('TeacherZoomClass@changeStatus')}}" method="post">
												@csrf
											...
											<td>
												...
												<a class="mb-xs mt-xs mr-xs btn btn-default btn-xs" href="{{ action('TeacherZoomClass@delete',$meeting->meeting_id) }}">Delete</a>

												<a class="mb-xs mt-xs mr-xs btn btn-default btn-xs" href="{{ action('TeacherZoomClass@edit',$meeting->id) }}">Edit</a>
                                                
                                                {{-- <a href="{{ url('teacher/meetings/participants/'.$meeting->meeting_id) }}" class="mb-xs mt-xs mr-xs btn btn-default btn-xs " ><i class="fa fa-eye"></i> See Meeting Participants</a>

                                                <a href="{{ url('teacher/meetings/attendance/'.$meeting->id) }}" class="mb-xs mt-xs mr-xs btn btn-default btn-xs " ><i class="fa fa-eye"></i> See Attendance</a> --}}
