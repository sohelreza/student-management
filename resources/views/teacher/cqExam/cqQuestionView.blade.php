									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
											  	...
											  	<a class="mb-xs mt-xs mr-xs btn btn-danger btn-xs" href="{{ action('TeacherCQExamController@delete_cq_question',$question->id) }}">Delete</a>
	                                             
											  	<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('TeacherCQExamController@edit_cq_question',$question->id) }}">edit</a>
