   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="{{action('TeacherCQExamController@create_cq_question')}}" method="post"  enctype="multipart/form-data">
									@csrf
									...
									{{-- <div class="form-group mb-3">
									    <label class="col-md-3 control-label">Question</label>
										    <div class="col-md-9">
												<textarea name="question_title" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'>
												</textarea>
											</div>
									</div> --}}
									<div class="form-group mb-3">
									    <label class="col-md-3 control-label">Question</label>
										    <div class="col-md-9">
												<textarea name="question_title" id="editor" rows="10"></textarea>
											</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label" for="inputDefault">Mark</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="mark" class="form-control" id="inputDefault">
										</div>
									</div>
...
<script>
       CKEDITOR.replace('editor', {
            ...
            filebrowserUploadUrl: '{{route('teacher.uploadCqImage', ['_token' => csrf_token() ])}}',
