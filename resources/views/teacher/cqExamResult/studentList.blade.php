								...
								<table class="table table-bordered table-striped mb-none" id="">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$student->exam->total_exam_marks}}</td>
											<td>{{$student->score}}</td>
                                           
												
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ url('teacher/cq_student_answer/'.$student->exam_id.'/student/'.$student->student_id)}}" >View Answer</a>

												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ url('teacher/cq_student_marking/'.$student->exam_id.'/student/'.$student->student_id)}}" >Marking</a>
