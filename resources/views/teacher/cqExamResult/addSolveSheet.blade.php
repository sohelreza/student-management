   ...
   <header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Add Solve Sheet</span></li>
							</ol>
					    </div>
					</header>
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Solve Sheet</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{action('TeacherCQExamController@post_solve_sheet',$cq_exam->id)}}" method="post" enctype="multipart/form-data">
									@csrf
