								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												<a href="{{url('/teacher/solve_download')}}/{{$exam->solve_sheet}}" class="text-success" >{{$exam->solve_sheet}}</a>
											</td>
											{{-- <td>
											...
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('TeacherCQExamController@cq_exam_result_view',$exam->id) }}">View Enrolled Students</a>

												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('TeacherCQExamController@add_solve_sheet',$exam->id) }}">Add Solve Sheet</a>
											</td>
