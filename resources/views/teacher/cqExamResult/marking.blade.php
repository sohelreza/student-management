   ...
   <header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Marking</h2>
							</header>
							...
							<div class="panel-body">
								<form class="" action="{{action('TeacherCQExamController@studentMarkingUpdate')}}" method="post">
									@csrf
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Score</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="score" id="inputDefault" value={{$exam_student->score}}>
											</div>
									</div>
                                    <div class="col-md-2">
                                    	<input type="hidden" name="id" value="{{$exam_student->id}}">
                                    </div>	 
									<div class="col-md-6">
                                    	<button type="submit" class=" mb-xs mt-xs mr-xs btn btn-primary btn-lg btn-block">Update</button>
                                    </div>	 
								</form>	
							</div>
						</section>
