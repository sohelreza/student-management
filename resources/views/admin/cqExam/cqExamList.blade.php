   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="add"  href="{{ action('AdminCQExamController@add_cq_exam') }}"><i class="fa fa-plus"></i> Add
								</a>
								</div>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
                                            ...
                                            <td>
												<form action="{{action('AdminCQExamController@change_cq_exam_status')}}" method="post">
												@csrf
											 ...
											 <td>
												<form action="{{action('AdminCQExamController@changeRankPublishStatus')}}" method="post">
												@csrf
													<input type="hidden" name="exam_id" value="{{$exam->id}}">
											...
											<td>
											  	...
											  	<a class="mb-xs mt-xs mr-xs btn btn-danger btn-xs" href="{{ action('AdminCQExamController@delete_cq_exam',$exam->id) }}">Delete</a>
	                                             
											  	<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('AdminCQExamController@edit_cq_exam',$exam->id) }}">Edit</a>

											  	<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('AdminCQExamController@add_cq_question',$exam->id) }}">Add Question</a>
											  	<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('AdminCQExamController@view_cq_question',$exam->id) }}">View Question</a>
											</td>
