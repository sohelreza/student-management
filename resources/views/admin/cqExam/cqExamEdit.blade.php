   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit CQ Exam</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{action('AdminCQExamController@update_cq_exam',$exam->id)}}" method="post">
									@csrf
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="teacher_id" >
												<option value="{{$exam->teacher_id}}" selected="true">{{$exam->teacher->name}}</option>
