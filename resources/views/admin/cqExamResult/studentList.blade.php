								...
								<table class="table table-bordered table-striped mb-none" id="">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ url('admin/cq_student_answer/'.$student->exam_id.'/student/'.$student->student_id)}}" >View Answer</a>

												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ url('admin/cq_student_marking/'.$student->exam_id.'/student/'.$student->student_id)}}" >Marking</a>
