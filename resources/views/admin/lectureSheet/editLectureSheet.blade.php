   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Lecture Sheet</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{action('AdminLectureSheetController@update',$lecture->id)}}" method="post" enctype="multipart/form-data">
									@csrf
									<input type="hidden" name="_method" value="PUT">
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="name" id="inputDefault" value="{{$lecture->name}}">
											</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="student_type" id="student_type">
												...
												<option value="0" {{ ($lecture->student_type == 0) ? 'selected="selected"' : '' }} >Offline</option>
												<option value="1" {{ ($lecture->student_type == 1) ? 'selected="selected"' : '' }} >Online</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="branch" id="branch">
												<option value="{{$lecture->branch}}" selected="true">{{$lecture->branchname->name}}</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="class" id="class">
												<option value="{{$lecture->class}}" selected="true">{{$lecture->classname->name}}</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="batch" id="batch">
												<option value="{{$lecture->batch}}" selected="true">{{$lecture->batchname->name}}</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="subject" id="subject">
												<option value="{{$lecture->subject}}" selected="true">{{$lecture->subjectname->name}}</option>
											</select>
										...
										<label class="col-md-2 control-label">Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="date" data-plugin-datepicker class="form-control" id="exam_date" value="{{$lecture->date}}">
													</div>
											</div>
									</div>
                                    <div class="form-group">
										<label class="col-md-2 control-label" for="textareaAutosize">Description</label>
										    <div class="col-md-6">
												<textarea class="form-control" name="description" rows="3" id="textareaAutosize" data-plugin-textarea-autosize>{{$lecture->description}}</textarea>
											</div>
									</div>
											...
											<div class="col-md-6">
												@if($lecture->file != null)
						                            ...
						                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
						                                ...
						                                <a href="{{url('/admin/lecture_download')}}/{{$lecture->file}}" class="text-success" ><i class="fa fa-download"></i> Download Lecture Sheet</a>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">File</label>
											<div class="col-md-6">
