   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="{{action('AdminStudentController@updateDueDate')}}" method="post">
									@csrf
										...
										<label class="col-md-2 control-label">Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="next_payment_date" data-plugin-datepicker class="form-control" id="exam_date" value="{{$student->next_payment_date}}">
													</div>
											</div>
									</div>
