											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">৳ {{$online_payment+$offline_payment}}</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="{{url('admin/student_payments')}}">(view all)</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">৳ {{$expense_month}}</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="{{url('admin/expenses')}}">(view all)</a>
													</div>
												</div>
											</div>
										</div>
