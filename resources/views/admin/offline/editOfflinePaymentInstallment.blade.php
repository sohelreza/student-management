   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="{{action('AdminOfflineStudentController@update_offline_payment_installment',$payment_installment->id)}}" method="post">
									@csrf
                                    	...
                                    	<div class="form-group">
											...
											<div class="col-md-6">
												<input type="number" name="paid_amount" class="form-control" id="inputDefault" value="{{$payment_installment->amount}}">
											</div>
										</div>
