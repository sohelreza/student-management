   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="{{action('AdminOfflineStudentController@create_offline_payment_installment',$payment->id)}}" method="post" id="formIns">
									@csrf
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="{{$payment->total_amount}}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="{{$payment->paid_amount}}">
										</div>
									</div>
