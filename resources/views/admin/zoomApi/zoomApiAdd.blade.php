   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Zoom Api Add</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{ action('ZoomApiController@store')}}" method="post" enctype="multipart/form-data" >
									@csrf
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_name" id="inputDefault" value="">
											</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Key</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_key" id="inputDefault" value="">
											</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Secret</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_secret" id="inputDefault" value="">
											</div>
									</div>
