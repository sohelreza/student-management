   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Zoom Api Info</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{ action('ZoomApiController@update',$zoomapi->id)}}" method="post" enctype="multipart/form-data" >
									@csrf
									<input type="hidden" name="_method" value="PUT">
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_name" id="inputDefault" value="{{$zoomapi->zoom_api_name}}">
											</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Key</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_key" id="inputDefault" value="{{$zoomapi->zoom_api_key}}">
											</div>
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Zoom API Secret</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="zoom_api_secret" id="inputDefault" value="{{$zoomapi->zoom_api_secret}}">
											</div>
									</div>
