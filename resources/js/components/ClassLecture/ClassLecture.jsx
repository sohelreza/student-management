...
class ClassLecture extends Component {
    constructor(props) {
        if (
        ...
        return (
            <>
                {this.state.contentsData.length === 0 ? (
                    <NoDataFound noDataFoundMessage="no class lectures uploaded yet" />
                ) : (
                    <>
                                ...
                                >
                                    Live Class History
                                                ...
                                                <td>
                                                    <Link
                                                        //  pathname: "/exam",
                                                        //  state: {id: data.id,student_id:this.state.student_id}
                                                        to={{
                                                            pathname:
                                                                "/pdf-viewer",
                                                            state: {
                            ...
                            <div className="col-md-9">
                                ...
                                <div className="app-background mb-3">
                                    ...
                                    <p className="text-center">
                                        Here you can find all your class
                                        lectures.
                                    </p>
                                </div>
